...
fn='./Figure4.png';
group_id=3;
subject_ID=[1,3,7,9,10,14,17,20]; % N=8 for G3 (control)
...
hold on
  title('CONTROL - ROC');
  plot(fpr_pre,sen_pre,'color',[0.8500 0.3250 0.0980],'linewidth',2); 
  plot(fpr_pos,sen_pos,'color',[0 0.4470 0.7410],'linewidth',2); 
